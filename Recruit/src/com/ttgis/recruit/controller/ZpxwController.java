...
public class ZpxwController {
	...
	public ModelAndView ZpxwContent(
	...
	public InterfaceResult setTop(@RequestParam("id") String id,
			@RequestParam("status") String status, String rtime, String ltime) {
		logInfo("id", id);
