...
public class JtjlkService {
	...
	public void updateByPrimaryKey(Jtjlk jtjlk) {
		JtjlkMapper.updateByPrimaryKey(jtjlk);
	}
	...
	public List<MyApplication> selectMyUniApplication(String userId) {
	    return JtjlkMapper.selectMyUniApplication(userId);
	}
