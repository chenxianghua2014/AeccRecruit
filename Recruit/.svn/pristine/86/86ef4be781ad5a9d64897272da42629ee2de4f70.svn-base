...
<body>
	...
	<div class="wrap clr">
		...
		<div class="content">
			<div class="conTop">
				<span>您的当前位置：首页 >> 校园招聘 >> 我的求职 >> 我的简历</span> <img src="images/tag04.png" />&nbsp; <strong>我的求职</strong>My Recruit
			</div>
			<div class="result">
				<div class="Tabbg">
					<a href="MyRecruit" class="Tabactive">我的简历</a>
				...
				<c:choose>
					...
					<c:otherwise>
						<iframe src="Grjl" id="frmResume" name="frmResume" width="100%" height="680" scrolling="auto" frameborder="0" allowtransparency="true"></iframe>
					</c:otherwise>
				</c:choose>
			</div>
		</div>
