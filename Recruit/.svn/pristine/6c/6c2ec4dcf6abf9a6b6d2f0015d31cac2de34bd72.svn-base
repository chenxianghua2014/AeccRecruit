	...
	<div class="editBlock">
		<table>
			<tbody>
				...
				<tr>
					<th style="text-align: left" width="150" rowspan="2"><input name="button" type="button" class="inputButton" value="添加" onclick="AddZwgl()" />
					</th>
					<td style="text-align: right;">职位名称:<input name="positionName" type="text" class="inputText" style="width:75px;" id="positionName" />&nbsp;&nbsp;招聘专业:<input
						name="positionZpzy" type="text" style="width: 75px;" class="inputText" id="positionZpzy" />&nbsp;&nbsp;
						是否优才职位:<select id=isuniposition
						name="isuniposition">
							<option value=""></option>
					...
					学历要求: <select id="positionXlyq" name="positionXlyq">
							<option value=""></option>
					...
					</select>&nbsp;&nbsp;工作地点: <select id="positionAddress" name="positionAddress">
							<option value=""></option>
...
<%--					<input name="positionZsdw" type="text" style="width: 100px;"--%>
						...
						</c:if>&nbsp;&nbsp;<input name="button" type="button" onclick="loadData()" class="inputButton" value="查询" /></td>
				</tr>
			</tbody>
		</table>
	</div>
