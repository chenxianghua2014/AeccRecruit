...
<body onload="loadpopup()">
	...
	<div class="wrap clr">
		<div class="menu">
			...
			<ul>
				<li><a href="UniPositionIntroduce" >优才招聘简介</a></li> 
				<li><a href="SearchUniPosition" style="color:#0046ae;">优才职位</a></li>
		...
		<div class="content">
			<div class="conTop">
				<span>您的当前位置：首页 >> 招聘优才</span> <img src="images/tag04.png" />&nbsp; <strong>查询职位</strong>Search Position
			</div>
			<c:choose>
						...
						<div class="result">
							...
							<table width="800px">
								<tr>
									...
									<td style="width:265px;text-align: center;">当前显示 <span id="start">1</span> - <span id="end">10</span> 条记录 共 <span id="count">0</span>
										条记录
									</td>
								</tr>
							</table>
