			...
			<tbody>
				<tr>
					<td style="text-align: right;">
						...
						<input type="hidden" id="jtjlkCzw" name="jtjlkCzw" />
				...
				<tr>
					...
					<td>
						<input name="button" type="button" onclick="Ly();" class="inputButton" value="录用" />
						&nbsp;
						<input name="button" type="button" onclick="excute();" class="inputButton" value="淘汰" />
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					<td style="text-align:right;">完成全部考试：</td>
					<td>
						<input name="button" type="button" onclick="excuteBatch('录用');" class="inputButton" value="录用" />
						&nbsp;
						<input name="button" type="button" onclick="excuteBatch('淘汰');" class="inputButton" value="淘汰" />
					</td>
				</tr>
			</tbody>
		</table>
