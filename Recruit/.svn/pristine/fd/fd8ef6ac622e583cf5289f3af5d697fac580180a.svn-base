...
public class QueryJtjlk extends PageCondition
{
	 ...
	 * 优才职位ID
	 */
	private String jtjlkUniPositionId;
	/**
	 * 判断是否优才职位
	 */
	...
	/**
	 * @return the jtjlkUniPositionId
	 */
	public String getJtjlkUniPositionId() {
	    return jtjlkUniPositionId;
	}
	...
	/**
	 * @param isunipositionId the isunipositionId to set
	 */
	...
	/**
	 * @param jtjlkUniPositionId the jtjlkUniPositionId to set
	 */
	public void setJtjlkUniPositionId(String jtjlkUniPositionId) {
	    this.jtjlkUniPositionId = jtjlkUniPositionId;
	}
