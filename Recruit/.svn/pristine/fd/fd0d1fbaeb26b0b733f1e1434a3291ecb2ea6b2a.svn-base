			...
			<tbody>
				<tr>
					<td height="32" colspan="4">
						<div class="neirong">
							<span>评论内容：</span> ${review.reviewNr}
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="right">
						回复人：
						<input name="replyName" type="text" class="inputText" id="replyName" />
						内容：
						<input name="replyNr" type="text" class="inputText" id="replyNr" />
						<input name="button" type="button" class="inputButton" value="查询" onclick="loadData('${review.reviewId}')" />
					</td>
				</tr>
			</tbody>
		</table>
