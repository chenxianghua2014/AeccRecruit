...
<script type="text/javascript" src="js/UniqtXzcc.js"></script>
</head>
<body>
	...
	<div class="wrap clr">
		<div class="menu">
			...
			<ul>
				...
				<!-- <li><a href="MyUniApplication" style="color:#0046ae;">我的申请(优才)</a></li>
				<li><a href="MyUniCollection">我的收藏(优才)</a></li> -->
			</ul>
		</div>
		<div class="content">
			<div class="conTop">
				<img src="images/tag04.png" />&nbsp; <strong>我的申请</strong>My
				Application <span>您的当前位置：首页 >> 优才招聘 >> 我的申请 >> 网上测评预约</span>
			</div>
			<c:choose>
