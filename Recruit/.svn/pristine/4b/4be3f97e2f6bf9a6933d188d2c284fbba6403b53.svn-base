	...
	<form method="post" name="FormMain" id="FormMain" action="UserLogin">
		...
		<div class="login">
			<table width="100%">
				...
				<tr>
					<td colspan="3">
						<input type="text" id="txtUserName" name="txtUserName" class="username" />
					</td>
				</tr>
				<tr>
					<td colspan="3">密 码</td>
				...
				<tr>
					<td colspan="3">
						<input type="password" id="txtPassword" name="txtPassword" class="password" />
					</td>
				</tr>
				<tr>
					<td colspan="3">验证码</td>
				...
				<tr>
					<td style="width: 200px;">
						<input name="rand" id="rand" type="text" value="" style="width: 150px;" />
					</td>
					<td colspan="2">
						<img title="换一张" onclick="javascript:RefreshCode();" id="randcode" src="image.jsp" />
					</td>
				</tr>
				<tr>
					<td colspan="3"></td>
				...
				<tr>
					<td colspan="3" align="center">
						<input type="button" class="inputButton" onclick="onSubmitLogin();"
