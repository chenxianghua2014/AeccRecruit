...
public class Jtjlk implements Serializable {
	 ...
	 * 
	 */
	private String jtjlkUniPositionZw;
	/**
	 * This field was generated by MyBatis Generator. This field corresponds to
	 * the database column JTJLK.JTJLK_POSITION_ID
	 * 优才岗位id
	...
	/**
	 * @return the jtjlkUniPositionZw
	 */
	public String getJtjlkUniPositionZw() {
	    return jtjlkUniPositionZw;
	}

	/**
	 * @param jtjlkUniPositionZw the jtjlkUniPositionZw to set
	 */
	public void setJtjlkUniPositionZw(String jtjlkUniPositionZw) {
	    this.jtjlkUniPositionZw = jtjlkUniPositionZw;
	}
