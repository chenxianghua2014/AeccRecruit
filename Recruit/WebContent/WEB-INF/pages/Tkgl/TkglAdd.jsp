...
<script type="text/javascript " src="resources/ueditor/dialogs/image/image.js"></script>
...
<body>
	...
	<div class="editBlock">
		<form name="ff" id="ff">
			<input type="hidden" id="tkglId" name="tkglId" value="${ tkgl.tkglId }" />
			<table>
				<tr>
				...
				<tbody>
					<tr>
						<th width="150">
							<span class="warning">*</span>试题编号
						</th>
						<td>
							<input type="text" id="TKGL_STBH" name="tkglStbh" value="${tkgl.tkglStbh}" dataType="Require" msg="必填" />
						</td>
					</tr>
					<tr>
						<th width="150">
							<span class="warning">*</span>试题类型
						</th>
						<td>
							<input type="text" id="TKGL_STLX" name="tkglStlx" value="${tkgl.tkglStlx}" dataType="Require" msg="必填" />
						</td>
					</tr>
					<tr>
						<th>
							<span class="warning">*</span>试题题干
						</th>
						<td>
							<script id="tkglSttg" name="tkglSttg" type="text/plain" style="width:100%;height:100px;" dataType="Require" msg="必填"></script>
						</td>
					</tr>
					<c:if test="${tkgl.tkglStlx ne 'L'}">
						<tr>
							<th>A</th>
							<td>
								<script id="tkglStxxA" name="tkglStxxA" type="text/plain" style="width:100%;height:60px;"></script>
							</td>
						</tr>
						<tr>
							<th>B</th>
							<td>
								<script id="tkglStxxB" name="tkglStxxB" type="text/plain" style="width:100%;height:60px;"></script>
							</td>
						</tr>
						<tr>
							<th>C</th>
							<td>
								<script id="tkglStxxC" name="tkglStxxC" type="text/plain" style="width:100%;height:60px;"></script>
							</td>
						</tr>
						<tr>
							<th>D</th>
							<td>
								<script id="tkglStxxD" name="tkglStxxD" type="text/plain" style="width:100%;height:60px;"></script>
							</td>
						</tr>
					</c:if>
					<tr>
						...
						<c:if test="${tkgl.tkglStlx eq 'L'}">
							<td>
								<input type="text" id="tkglStda" name="tkglStda" value="${tkgl.tkglStda}" />
							</td>
						</c:if>
						<c:if test="${tkgl.tkglStlx ne 'L' }">
							<td>
								A
								<input type="radio" id="tkglStda" name="tkglStda" value="A" <c:out value="${tkgl.tkglStda== 'A'?'checked':''}"/> />
								B
								<input type="radio" id="tkglStda" name="tkglStda" value="B" <c:out value="${tkgl.tkglStda== 'B'?'checked':''}"/> />
								C
								<input type="radio" id="tkglStda" name="tkglStda" value="C" <c:out value="${tkgl.tkglStda== 'C'?'checked':''}"/> />
								D
								<input type="radio" id="tkglStda" name="tkglStda" value="D" <c:out value="${tkgl.tkglStda== 'D'?'checked':''}"/> />
							</td>
						</c:if>
					</tr>
					<tr>
						<th></th>
						<td>
							<input type="button" class="inputButton" value="确认添加" onclick="TkglSava();" />
							&nbsp;&nbsp;
