		...
		<div class="content">
			...
			<div>
				<form name="form1" id="form1">
					<input type="hidden" name="userId" value="${user.userId}" /> <input type="hidden" id="userAge" name="userAge" value="${user.userAge}" />
					<div class="cpList">
						<table width="100%">
							<tr>
								...
								<td><input type="text" maxlength="20" id="userIdcard" name="userIdcard" value="${user.userIdcard}" onblur="checkUserIdcard()"
									dataType="Require" class="inputReg" msg=" 请填写您的登录名" /></td>
							</tr>
							<tr>
								<th><span class="warning">*</span>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名:</th>
								<td><input type="text" id="userName" name="userName" value="${user.userName}" dataType="Limit" min="1" max="5" class="inputReg"
									msg=" 请填写您的真实姓名" /><span style="color: green;">&nbsp;请输入您的真实姓名，将作为简历信息，无法更改。</span></td>
							</tr>
							<tr>
								<th><span class="warning">*</span>身份证号:</th>
								<td><input type="text" id="userSfzh" name="userSfzh" value="${user.userSfzh}" onblur="checkUserSfzh()" class="inputReg" dataType="IdCard"
									msg=" 请填写您的真实身份证号" /><span style="color: green;">&nbsp;请正确填写，否则将影响您身份核对和测评考试。</span></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" maxlength="11" id="userTelephone" name="userTelephone" value="${user.userTelephone}" onblur="checkUserTelephone()"
									class="inputReg" dataType="Mobile" msg=" 请填写正确格式" /><span style="color: green;">&nbsp;请正确填写，否则将影响您接收测评面试通知。 </span></td>
							</tr>
							<tr>
								<th><span class="warning">*</span>电子邮箱:</th>
								<td><input type="text" id="userEmail" name="userEmail" class="inputReg" value="${user.userEmail}" onblur="checkUserName()"
									dataType="Email" msg=" 请填写正确格式" /><span style="color: green;">&nbsp;请正确填写，否则将影响您接收测评面试通知。 </span></td>
							</tr>
							<tr>
							...
							<tr>
								<td></td>
								<td><input type="button" class="inputButton" id="btnSubmit" value="确定" onclick="checkPass();" /> &nbsp;&nbsp; <input type="button"
									class="inputButton" value="取消" onclick="goMain('${user.userId}');" /></td>
							</tr>
						</table>
					</div>
				</form>
