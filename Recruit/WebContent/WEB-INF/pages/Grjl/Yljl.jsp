	...
	<div id="ul1" class="editBlock" style="height: 640px;">
		<div id="div1">
			<table>
				<tbody>
					<tr>
						<td colspan="2" class="subtitle">个人信息</td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<table>
				<tbody>
					...
					<tr>
						...
						<td rowspan="4" style="width: 90px"><img
							src="${ mv.model['resume'].resumePhotos }" width="90"
							height="100"></td>
					</tr>
					<tr>
						<th>出生日期</th>
		...
		<div id="ddiv3">
			<c:forEach items="${ mv.model['Jyjl']}" var="map" varStatus="status">
				<table>
					...
					<tr>
						<th>学校名称</th>
						<td colspan="3">${map.resumeXxmc}</td>
					</tr>
					<tr>
						<th>专业</th>
						<td colspan="3">${map.resumeZyl}&nbsp;&nbsp;${map.resumeZy}</td>
					</tr>
					<tr>
						<th>学历</th>
						<td colspan="3">${map.resumeXl}</td>
					</tr>
					<tr>
						<th>专业描述</th>
		...
		<div id="ddiv11">
			...
			<c:forEach items="${ mv.model['Yynl']}" var="map" varStatus="status">
				<table>
					<tr>
						<th style="width: 155px; height: 27px">语言类别</th>
		...
		<div id="div10">
			<table>
				<tbody>
					<tr>
						<td colspan="2" class="subtitle">培训经历</td>
					</tr>
				</tbody>
			</table>
		</div>
		<div id="ddiv10">
			...
			<c:forEach items="${ mv.model['Pxjl']}" var="map" varStatus="status">
				<table>
					<tr>
						<th style="width: 155px; height: 27px">培训名称</th>
					...
					<tr>
						<th>培训时间</th>
						<td colspan="3">${map.resumePxsj}到${map.resumePxsj1}</td>
					</tr>
					<tr>
						<th>培训内容</th>
				...
				<table>
					<tbody>
						<tr>
							...
							<td>${ map.resumeQtxxlb1 }&nbsp;${ map.resumeQtxxlb2 }</td>
						</tr>
						<tr>
							<th>信息描述</th>
				...
				<tr>
					<td class="toolbar" style="width: 200px"><c:choose>
							<c:when test="${mv.model['JtjlkId'] eq null}">
								<input type="button" onclick="newPDF()" class="inputButton"
									value="下载简历" />
							</c:when>
