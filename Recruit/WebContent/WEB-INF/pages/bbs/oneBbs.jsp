...
<body>
	...
	<div class="wrap clr">
		...
		<div class="content">
			<div class="conTop">
				<img src="images/cpgl/tag04.png" />&nbsp; <strong>科工论坛</strong>BBS <span>您的当前位置：首页 >> 交流社区 >> 科工论坛</span>
			</div>
			<div class="main">
				<div class="Tab">
					<span>标签:</span>
					<c:forEach items="${ltbqList}" var="map">
						<a href="javascript:void(0);" onclick="javascript:window.location='queryByBq?ltbqName=${map.ltbqName}&ltbqId=${map.ltbqId}'"
				...
				<div class="bbscontent">
					${bbs.bbsNr}
					<div class="bssName">
						发布人：${bbs.bbsFbr}<span>时间：${bbs.fbsj}</span>
					</div>
				</div>
				<div class="publish" style="margin-top:30px;">
					<form name="ff" id="ff">
						...
						<div class="pubfb">
							<div class="pubright">
								<a href="javascript:void(0);" onclick="qtReviewSave();">发表</a>
							</div>
						</div>
					</form>
				</div>
				...
				<table width="800px">
					<tr>
						...
						<td style="width:265px;text-align: center;">
							当前显示 <span id="start">1</span> - <span id="end">10</span> 条记录 共 <span id="count">0</span> 条评论记录
						</td>
					</tr>
				</table>
			</div>
