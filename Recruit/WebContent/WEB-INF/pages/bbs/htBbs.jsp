...
<body>
	...
	<div class="editBlock">
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">
				...
				<tr>
					<td style="text-align: left;">
						<input name="button" type="button" class="inputButton" value="添加" onclick="htBbsAdd();" />
					</td>
					<td align="right">
						内容：
						<input name="bbsNr" type="text" class="inputText" id="bbsNr" />
						发布人：
						<input name="bbsFbr" type="text" class="inputText" id="bbsFbr" />
