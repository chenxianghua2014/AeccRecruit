		...
		<table>
			<tbody>
				...
				<tr>
					<td align="right">
						发布人：
						<input name="reviewPlr" type="text" class="inputText" id="reviewPlr" />
						内容：
						<input name="reviewNr" type="text" class="inputText" id="reviewNr" />
						<input name="button" type="button" class="inputButton" value="查询" onclick="loadData('${bbsId}')" />
					</td>
				</tr>
			</tbody>
		</table>
