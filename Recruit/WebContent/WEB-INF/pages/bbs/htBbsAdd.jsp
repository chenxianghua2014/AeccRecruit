...
<script type="text/javascript">
	$(document).ready(
			function() {
				$("#ltbkId").find("option[value='${bbs.ltbkId}']").attr(
						"selected", true);
			});
	...
	<div class="editBlock">
		<form name="ff" id="ff">
			...
			<table boder="0">
				...
				<tr>
					<th width="150">
						<span class="warning">*</span>帖子内容:
					</th>
					<td colspan="2">
						<script id="bbsNr" name="bbsNr" type="text/plain" style="width:100%;height:300px;"></script>
					</td>
				</tr>
				<tr>
					<th width="150"></th>
