...
<div id="header">
	<div class="top">
		...
		<div class="loginLink">
			<a href="javascript:void(0);" style="font-weight: bold;">校园招聘</a> |
			<c:choose>
		...
		<div class="navL">
			<div class="navR">
				<ul class="clr">
					...
					<li><a href="GroupIntroduction">集团概况</a></li>
					...
					<li><a href="SearchUniPosition">优才计划</a></li>
					<li><a href="MyRecruit">我的求职</a></li>
					<li><a href="AboutOnlineApplication">招聘指南</a></li>
					<li style="background: none;"><a href="http://www.casic.com.cn/"><img src="images/btnIndex.png" />
					</a></li>
				</ul>
			</div>
		</div>
