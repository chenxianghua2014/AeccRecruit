		...
		<div class="content">
			...
			<div class="main">
				<div class="Possearch cls">
				    <input name="isuniposition" id="isuniposition" type="text" style="width:236px; display:none" value = "0"/>
					...
					<table width="800px">
						<thead>
							<tr>
								...
								<td style="width:9%;">职位类别</td>
								<td style="width:7%;">学历要求</td>
								<td style="width:9%;">招聘专业</td>
								<td style="width:5%;">人数</td>
								<td style="width:9%;">招聘类别</td>
								<td style="width:12%;">招聘单位</td>
								<td style="width:7%;">工作地点</td>
								<td style="width:9%;">发布时间</td>
								<td style="width:9%;">职位状态</td>
