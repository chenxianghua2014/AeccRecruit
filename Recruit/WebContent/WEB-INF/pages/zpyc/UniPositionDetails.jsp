...
<body>
	...
	<div class="wrap clr">
		...
		<div class="content">
			<div class="conTop">
				<span>您的当前位置： 招聘优才 >> 优才职位 >> 职位详情</span> <img src="images/tag04.png" />&nbsp;
				<strong>职位详情</strong>Position Details
			</div>
			<div class="main">
				<br />
				<table style="width: 100%;">
					...
					<tr>
						<th>薪资范围（万）</th>
						<td>${ position.payLow }~${ position.payHigh }</td>
					</tr>
					<tr>
						<th>特殊支持政策</th>
						<td>${ position.positionSpepol }</td>
					</tr>
				</table>
				<div class="seabtn">
					<table align="center">
