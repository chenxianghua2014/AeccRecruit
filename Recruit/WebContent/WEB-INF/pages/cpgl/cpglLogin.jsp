		...
		<form name="ff" id="ff">
			<table width="100%">
				...
				<tr>
					<td>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</td>
					<td>
						<input type="text" name="bmglKsxm" dataType="Require" msg="请填写您的报考姓名" />
					</td>
				</tr>
				<tr>
					<td>身份证号：</td>
					<td>
						<input type="text" name="bmglSfzh" dataType="Require" msg="请填写正确身份证号" />
					</td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					<td colspan="2" align="center" class="cpgldl">
						<a href="javascript:void(0);" onclick="CpglLogin();">登录</a>
					</td>
				</tr>
			</table>
		</form>
