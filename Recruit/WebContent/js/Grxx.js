	...
	$("#ddiv3")
			.append(
					"<div id="
							...
							+ "</th>"
							+ "<td colspan=\"3\">"
							+ "<textarea  cols=\"58\" rows=\"4\" name=\"resumeZyms\"  maxlength=\"500\"    data-rule=\"专业描述:required;\" >"
	...
	$("#ddiv8")
			.append(
					"<div id="
							...
							+ "</th>"
							+ "<td>"
							+ "<input type=\"text\" class=\"inputText\" id=\"resumeGzgs\" name=\"resumeGzgs\"  data-rule=\"工作单位:required;\" maxlength=\"20\" value="
							...
							+ "</th>"
							+ "<td colspan=\"3\">"
							+ "<input type=\"text\" class=\"inputText\" id=\"resumeGzcs\" name=\"resumeGzcs\"    maxlength=\"20\" value="
							...
							+ "</th>"
							+ "<td colspan=\"3\">"
							+ "<input type=\"text\" class=\"inputText\" id=\"resumeGzbm\" name=\"resumeGzbm\"   maxlength=\"20\" value="
							...
							+ "</th>"
							+ "<td colspan=\"3\">"
							+ "<input type=\"text\" class=\"inputText\" id=\"resumeGzsj\" name=\"resumeGzsj\" data-rule=\"开始日期: required; date;\"   onfocus=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\"    value="
							+ (gzjls == undefined ? '' : gzjls.resumeGzsj)
							+ ">"
							+ "&nbsp"
							+ "到"
							+ "&nbsp"
							+ "<input type=\"text\" class=\"inputText\"  name=\"resumeGzsj1\"   data-rule=\"结束日期: required; date; match[gt, resumeGzsj, date]\"  onfocus=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\"     value="
	...
	$("#ddiv10")
			.append(
					"<div id="
							...
							+ "</th>"
							+ "<td>"
							+ "<input type=\"text\" class=\"inputText\" id=\"resumePxmc\" name=\"resumePxmc\"  data-rule=\"培训名称:required;\"   maxlength=\"20\" value="
							...
							+ "</th>"
							+ "<td colspan=\"3\">"
							+ "<input type=\"text\" class=\"inputText\" id=\"resumePxjg\" name=\"resumePxjg\"    maxlength=\"20\" value="
							...
							+ "</th>"
							+ "<td colspan=\"3\">"
							+ "<input type=\"text\" class=\"inputText\" id=\"resumePxsj\" name=\"resumePxsj\" data-rule=\"开始日期: required; date;\"  onfocus=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\"     value="
							+ (pxjls == undefined ? '' : pxjls.resumePxsj)
							+ ">"
							+ "&nbsp"
							+ "到"
							+ "&nbsp"
							+ "<input type=\"text\" class=\"inputText\"  name=\"resumePxsj1\"  data-rule=\"结束日期: required; date; match[gt, resumePxsj, date]\"  onfocus=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\"     value="
							...
							+ "</th>"
							+ "<td colspan=\"3\">"
							+ "<textarea id=\"resumePxnr\" cols=\"58\" rows=\"4\" name=\"resumePxnr\"   maxlength=\"500\" >"
	...
	$("#ddiv11")
			.append(
					"<div id="
							...
							+ "<select id="
							+ bb5
							+ " name=\"resumeYylb\" data-rule=\"语言类别:required\";  onChange=\"javascript:qita(this.id);\">"
							+ "<option value=\"\">"
							+ ""
							+ "</option>"
							+ "<option value=\"英语\">"
							...
							+ "<select id="
							+ bb6
							+ " name=\"resumeTsnl\" data-rule=\"听说能力:required\";>"
							+ "<option value=\"\">"
							+ ""
							+ "</option>"
							+ "<option value=\"一般\">"
							...
							+ "</th>"
							+ "<td colspan=\"3\">"
							+ "<input type=\"text\" class=\"inputText\" id=\"resumeYyfs\" name=\"resumeYyfs\"   data-rule=\"语言分数:required;\"  maxlength=\"20\" value="
